    ...
    <>
      ...
      <ConditionsText>
        <p>
          ...
          до душі - не зволікайте, реєструйтесь швидше на фотосесію! Для цього
          перейдіть за{" "}
          <QuestLink
          ...
          Вас щодо кожної конкретної колекції, відповість на ваші запитання,
          перегляне графік фотосесій, щоб обрати комфортні для Вас дату та час
          зйомки, детально розповість що, де і як відбуватиметься та як
          попередньо підготуватись до фотосесії.
        </p>
      </ConditionsText>
    </>
  );
